...
export const meetingMocks: CrmMeeting[] = [
  {
    ...
    participants: [
      ...
      { id: "u_3", name: "Sara Ahmed", email: "sara.ahmed@finlonexa.com" },
    ],
    relatedDealId: "d_001",
    relatedDealName: "Techno Automation Suite",
    relatedContactId: "ct_001",
    relatedContactName: "Ahmed Khan",
    meetingLink: "https://meet.finlonexa.com/techno-review",
    status: "scheduled",
  ...
  },
  {
    ...
    participants: [
      ...
      { id: "u_4", name: "Zain Malik", email: "zain.malik@finlonexa.com" },
    ],
    relatedDealId: "d_006",
    relatedDealName: "Skyline Retail Omnichannel",
    relatedContactId: "ct_006",
    relatedContactName: "Omar Farooq",
    meetingLink: "https://meet.finlonexa.com/skyline-contract",
    status: "scheduled",
  ...
  },
  {
    ...
    participants: [
      ...
      { id: "u_2", name: "Ali Khan", email: "ali.khan@finlonexa.com" },
    ],
    relatedDealId: "d_009",
    relatedDealName: "Lotus Digital Agency Suite",
    relatedContactId: "ct_009",
    relatedContactName: "Hina Shah",
    meetingLink: "https://meet.finlonexa.com/lotus-tech",
    status: "scheduled",
  ...
  },
  {
    ...
    participants: [
      ...
      { id: "u_1", name: "Hussain Ali", email: "hussain.ali@finlonexa.com" },
    ],
    relatedDealId: "d_003",
    relatedDealName: "Nova Cloud Migration",
    relatedContactId: "ct_003",
    relatedContactName: "John Smith",
    meetingLink: "https://meet.finlonexa.com/nova-demo",
    status: "scheduled",
  ...
  },
  {
    ...
    meetingLink: "https://meet.finlonexa.com/brightwave-intro",
    status: "scheduled",
  ...
  },
  {
    ...
    meetingLink: "https://meet.finlonexa.com/greentech-walkthrough",
    status: "scheduled",
